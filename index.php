...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">Travel Easy</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link fw-bold py-1 px-3 text-white" href="">Home</a>
        <a class="nav-link fw-bold py-1 px-3 text-white" href="register.php">Create Account</a>
        <a class="nav-link fw-bold py-1 px-3 text-white" href="login.php">Login</a>
      </nav>
    </div>
  </header>
  ...
  <main class="px-3">
    ...
    <p class="lead">
      <a href="login" class="btn btn-lg btn-light fw-bold border-white bg-white">Book a Car</a>
    </p>
  </main>
