...
if(isset($_POST['submit'])){
    ...
    if(count($error) ==0){
      ...
      $check="SELECT * FROM users WHERE email='$email' AND password='$encryptedpass' ";
      ...
      if(mysqli_num_rows($query) > 0){
          ...
          array_push($error, "Incorrect email of password");
      }
    }
  ...
  <form action="<?=$_SERVER['PHP_SELF']?>" method='post'>
    ...
    <?php 
      if(isset($_COOKIE['msg'])){
        echo "<span class='text-danger'>".$_COOKIE['msg']."</span>";
      }
