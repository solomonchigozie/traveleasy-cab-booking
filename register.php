...
if(isset($_POST['register'])){
    ...
    if(empty($address)){
        array_push($error, "Enter your address");
    }
    if(empty($phone)){
    ...
    if(count($error) == 0){
      //insert record to database if there was no error
        $encryptpassword = md5($password);
        $insert = "INSERT INTO users(fullname, email, address, phone, password) 
        VALUES('$fullname','$email', '$address','$phone', '$encryptpassword') ";
  ...
  <form action="<?=$_SERVER['PHP_SELF']?>" method='post'>
    ...
    <h1 class="h3 mb-3 fw-normal">Please sign in</h1>
            ...
            <span class="text-danger">
                    <?php foreach($error as $errors){echo $errors . " <br>"; } ?>
                </span>
    ...
    <div class="form-floating">
      <input type="number" class="form-control" name="phone" id="phonenumber" placeholder="Phone number">
